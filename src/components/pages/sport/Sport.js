...
function Sport() {
    ...
    useEffect(() => {
        fetch("https://pacific-caverns-96128.herokuapp.com/https://www.ntv.com.tr/sporskor.rss")
            .then((res) => res.text())
    ...
    return (
        <div>
            <div className='flex bg-sky-900 justify-around h-14 items-center'>
                <a href="/" className=''>
                    <img className='mr-36' src="https://cdn.ntv.com.tr/img/SporSkorLogo.svg?v=6389" alt="ntv.com.tr"></img>
                </a>
                        ...
                        txt[0] ? (
                            <div className='relative w-full mx-auto object-contain h-full bg-white flex justify-center'>
                                <a href={`${txt[0].linkContent[count]}`}>
                                    <img src={txt[0].imageContent[count]} className="bg-cover bg-center bg-origin-padding bg-origin-border w-full h-full" alt="sportimage" />
                                </a>
                            ...
                            <>
                                {
                                    order2.map(item => (
                                        <div className='row-span-3 w-full h-full bg-white grid grid-cols-2'>
                                            ...
                                            <p className='col-span-1 my-auto px-2 text-xs text-blue-900 font-bold text-left'>{txt[0].textContent[item]}</p>
                                        </div>
                                    ))
                                }
                            </>
                ...
                <div className='relative grid grid-cols-3 grid-rows-1 col-span-3 row-span-1 w-full h-auto'>
                    {
                        txt[0] ? (
                            <>
                                {
                                    <>
                                        <button type="button" className="cursor-default absolute mt-10">
                                            <span onClick={() => handleClickPrev2()} className="bg-sky-800 inline-flex w-8 h-10">
                                                <svg className="text-white" fill='white' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 451.847 451.847">
                                    ...
                                    c-12.354,12.365-32.386,12.365-44.745,0l-194.29-194.281C100.226,242.115,97.141,234.018,97.141,225.92z"/>
                                        ...
                                        <button type="button" className="cursor-default absolute mt-10 right-0">
                                            <span onClick={() => handleClickNext2()} className="bg-sky-800 inline-flex w-8 h-10">
                                                <svg className="text-white" fill='white' version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 451.846 451.846">
                    ...
                    }
                    {
                        txt[0] ? (
                            <>
                                {
                                    order9.map(item => (
                                        <div className='row-span-3 p-3 w-full h-full bg-white grid grid-cols-2'>
                                            <a href={`${txt[0].linkContent[item]}`}>
                                                <img src={txt[0].imageContent[item]} alt='' className='bg-gray-200 row-span-1 w-full h-full bg-contain'></img>
                                            </a>
                                            <p className='hover:ease-in duration-300 hover:bg-sky-800 hover:text-white bg-gray-200 px-2 text-xs text-black w-full h-full font-bold text-left'>{txt[0].textContent[item]}</p>
                                        </div>
                                    ))
                                }
                            </>
                        ...
                        <>
                            {
                                <div className='flex bg-sky-900 mt-10 justify-around h-14 items-center'>
                                    <a href="/" className=''>
                                        <img className='mr-12' src="https://www.ntv.com.tr/img/SporSkorLogo--footer.svg" alt="ntv.com.tr"></img>
                                    </a>
                                    <a href="https://ntv.com.tr">
